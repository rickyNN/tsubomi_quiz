const quizDataJp = [
  ...
  {check: 'G2_ryuge_SS',
  question: '第３問\n中部地方に位置し、製品出荷額が日本一の工業地帯は？',
  a: '中京工業地帯',
  b: '東海工業地域',
  c: '阪神工業地帯',
  d: '太平洋ベルト',
  explanation: 'この問題の解説\n答え：a 中京工業地帯では、豊田市の自動車工業がさかんですね！',
  correct: 'a'},
  
  {check: 'G2_ryuge_SS',
  question: '第４問\n静岡県牧ノ原台地で生産がさかんな農産物は？',
  a: 'ピーマン',
  b: '茶',
  c: 'コーヒー豆',
  d: '大根',
  ...
  {check: 'G2_ryuge_SS',
  question: '第５問\n甲府盆地などに広がる、山から平野に流れてきた堆積物でできた地形を何という？',
  a: '扇状地',
  b: '三角州',
  c: '扇風機',
  d: 'シラス台地',
  explanation: 'この問題の解説\n答え：bの三角州は、川の河口から湾に注ぐところでできた地形ですね！',
  correct: 'a'},
  
  {check: 'G2_ryuge_SS',
  question: '第６問\n季節風は、冬はどの方位から吹いてきますか？',
  a: '北東',
  b: '北西',
  c: '南東',
  d: '南西',
  explanation: 'この問題の解説\n答え：b 北西\ncの南東は夏で、暖かく湿った空気を運んできますね！',
  correct: 'b'},
  
  {check: 'G2_ryuge_SS',
  question: '第７問\n関東地方で、住宅不足の解消のため、再開発されたまちを何という？',
  a: '眠らない町',
  b: 'グランドライン',
  c: 'ホームタウン',
  d: 'ニュータウン',
  ...
  {check: 'G2_ryuge_SS',
  question: '第１０問\n東北三大祭りとは、秋田の竿燈まつり、青森のねぶた祭り、あともう一つは？',
  a: '祇園祭',
  b: '七夕祭り',
  c: 'わっしょいわっしょい祭り',
  d: '渋川神社祭り',
  ...
  {check: 'G2_ryuge_SS',
  question: '第１２問\n岩手県の太平洋側は三陸海岸といって、海岸線が入り組んだギザギザになっている。この地形を何という？',
  a: 'ギザギザ海岸',
  b: 'リアス海岸',
  c: 'フィヨルド',
  d: 'ベホイミ',
  explanation: 'この問題の解説\n答え：b リアス海岸\ncのフィヨルドは、北欧で見られ、氷河で削られてギザギザになった海岸です！',
  correct: 'b'},
  
  {check: 'G2_ryuge_SS',
  question: '第１３問\n親潮（寒流）と黒潮（暖流）がぶつかるところを何という？',
  a: 'グランドライン',
  b: '出会いの場',
  c: '潮目（潮境）',
  d: 'フォッサマグナ',
  ...
  {check: 'G2_ryuge_SS',
  question: '第１４問\n北海道西部で、稲作がさかんな平野を何という？',
  a: '石狩平野',
  b: '十勝平野',
  c: '濃尾平野',
  d: '越後平野',
  explanation: 'この問題の解説\n答え：a 石狩平野\nbの十勝平野は、北海道の東部に位置し、畑作がさかんです。',
  correct: 'a'},
  
  {check: 'G2_ryuge_SS',
  question: '第１５問\n北海道北東部に広がる、世界自然遺産に登録されている半島は？',
  a: '能登半島',
  b: '房総半島',
  c: 'スカンジナビア半島',
  d: '知床半島',
